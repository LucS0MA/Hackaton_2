...
function NewsLetters() {
  ...
  return (
    <div className={`backGroundNL ${closeNewsLetter ? "visible" : "hidden"}`}>
      <div
        className={`ModalNewsLetter ${closeNewsLetter ? "visible" : "hidden"}`}
      >
        ...
        <div className="text">
          ...
          <p className="textNL">
            Kaliméra (Bonjour) <br />
            <br />
            Ne ratez aucune Promo divine ! Inscrivez-vous à notre newsletter et
            soyez les premiers à profiter d'offres antique exclusives.
            Renseignez simplement votre adresse email pour débloquer des
            réductions sensationnelles. Ne passez pas à côté, l'économie
            commence par un clic !
          </p>
          <input
            className="inputNL"
            type="text"
            placeholder="   Zeus-la-foudre@Olympe.com"
          />
          ...
          {isSubscribed && (
            <p className="thxSub">
              {" "}
              ⚡ Non de Zeus, Merci pour votre inscription à notre Newsletter !
              ⚡{" "}
            </p>
          )}
          {isInputEmpty && (
            <p className="thxSub">
              {" "}
              ⚠️ Merci de renseigner votre email pour pouvoir accéder aux
              avantages divins ! ⚠️{" "}
            </p>
          )}
        </div>
